...
function Container({ data }) {
  ...
  }, [token, data, dispatch, localStream, publishStream, userInfo]);
  ...
  const endCall = () => {
    ...
    const event = data.callType === "voice" ? "reject-voice-call" : "reject-video-call";
    socket.current.emit(event, { from: id });
