...
import { MdOutlineEnd } from "react-icons/md";
...
<span className="text-5x1">{data.name}</span>
...
I <div className="h-16 w-16 bg-red-600 flex items-center justify-center rounded-full">
<MdOutlineEnd 
